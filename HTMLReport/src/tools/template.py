...
<head>
    <title>{title}</title>
    <link href="../icons/32.ico" rel="icon" type="image/x-ico">
...
<table>
  <tr>
    <td style="width: 100%; vertical-align: top;">
      <p class='attribute'><strong><span class="lang-cn">启动时间：</span></strong> {startTime}  </p>
      <p class='attribute'><strong><span class="lang-cn">结束时间：</span></strong> {endTime}  </p>
      <p class='attribute'><strong><span class="lang-cn">运行时长：</span></strong> {duration}  </p>
      <p class='attribute'>
        <strong><span class="lang-cn">结果：</span></strong>
        <span class="lang-cn">合计：</span><span class="totalNum">{total}  </span>
        <span class="lang-cn">通过：</span><span class="totalPass"> {Pass}  </span>
        <span class="lang-cn">失败：</span><span class="totalFailed"> {fail}  </span>
        <span class="lang-cn">错误：</span><span class="totalError"> {error}  </span>
        <span class="lang-cn">跳过：</span><span class="totalSkip"> {skip}  </span>
      </p>
     <p class='description'>{description}</p>
    </td>
    <td>
      <div height="400" width="600"><canvas id="chart" style="border: 1px solid #A4E2F9;"> 你的浏览器不支持HTML5 canvas </canvas></div>
    </td>
  </tr>
</table>
</div>"""
    ...
    REPORT_TMPL = r"""<p id='show_detail_line'>筛选
      <a href='javascript:showCase(0)'><span class="lang-cn">摘要</span></a>
      <a href='javascript:showCase(1)'><span class="lang-cn">通过</span></a>
      <a href='javascript:showCase(2)'><span class="lang-cn">失败</span></a>
      <a href='javascript:showCase(5)'><span class="lang-cn">异常</span></a>
      <a href='javascript:showCase(3)'><span class="lang-cn">跳过</span></a>
      <a href='javascript:showCase(4)'><span class="lang-cn">全部</span></a>
    </p>
<table id='result_table'>
    <tr id='header_row'>
      <th><span class="lang-cn">序号</span></th>
      <th><span class="lang-cn">测试组/测试用例</span></th>
      <th><span class="lang-cn">计数</span></th>
      <th><span class="lang-cn">通过</span></th>
      <th><span class="lang-cn">失败</span></th>
      <th><span class="lang-cn">错误</span></th>
      <th><span class="lang-cn">跳过</span></th>
      <th><span class="lang-cn">统计</span></th>
      <th><span class="lang-cn">重试</span></th>
      <th><span class="lang-cn">查看</span></th>
    </tr>
    {test_list}
    <tr id='total_row'>
        <td>&nbsp;</td>
        <td><span class="lang-cn">合计</span></td>
        <td>{count}</td>
...
"""
    ...
    <td style="text-align:right;">{statistics:.2%}</td>
    <td>{tries}</td>
    <td><a href="javascript:showClassDetail('{cid}',{count})"><span class="lang-cn">细节</span></a></td>
</tr>
"""
...
"""
    ...
    <figure>
        <img class="pic" src='http://10.0.2.83/report/pic/loading.gif' data-original='{img_src}' title='{alt}' alt='{title}'/>
    </figure>
    {title}
</li>
"""
