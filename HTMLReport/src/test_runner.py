...
class TestRunner(TemplateMixin, TestSuite):
    ...
    def __init__(self, report_file_name: str = None, log_file_name: str = None, output_path: str = None,
        ...
        self.js_file_name = os.path.join(dir_to, 'index.js')#add by joffrey
    ...
    def _generate_report(self, result):
        ...
        with open(self.path_file, "w", encoding="utf8") as report_file:report_file.write(output)
        with open(self.js_file_name, "w", encoding="utf8") as js_file:js_file.write(js)#add by joffrey
